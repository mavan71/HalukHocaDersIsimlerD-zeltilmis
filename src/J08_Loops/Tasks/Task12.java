...
public class Task12 {
    public static void main(String[] args) {
        ...
        System.out.println("Ağam Beş sayı gir");
int toplam=0;//işleme etki etmeyecek boş bir kutu tanımladık
        for(int i=1; i<=5;i++){// bir den beşe kadar bir artımlı tekrar tanımlandı
         System.out.print(i+". sayi giriniz");
         int sayi=input.nextInt();
            if (sayi<=10||sayi>=20){//girilen sayının 10 ila 20 arası olmama şartı.
